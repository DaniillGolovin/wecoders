        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="who-we">
                    <h2 class="title-1"><?$APPLICATION->IncludeComponent(
                            ...
                            Array(
                                "AREA_FILE_SHOW" => "file",
                                "PATH" => SITE_TEMPLATE_PATH . '/includes/services/services_title.php'
                            )
                        );?></h2>
                    <?$APPLICATION->IncludeComponent(
                        ...
                        Array(
                            "AREA_FILE_SHOW" => "file",
                            "PATH" => SITE_TEMPLATE_PATH . '/includes/services/services_about_us.php'
                        )
                    );?>
                </div>
            </div>
            <?$APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "COMPONENT_TEMPLATE" => "services_skills"
                ),
                false
            );?>
        </div>
